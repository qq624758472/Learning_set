...
if(s.os.iphone&&c.isWechat&&s.os.getNumVersion()>=10.3&&(c.gtVersion("7.0.14",1)&&s.os.getNumVersion()<15||c.gtVersion("8.0.7"))||s.os.android&&c.isWechat&&c.gtVersion("7.0.15",1)&&s.os.getNumVersion()>=5)document.addEventListener("WeixinOpenTagsReady",function(){
_={
status:"ready"
},n();
