...
if(k&&(i.old_liked||a.old_liked_before?k.render("praise",!0):i.liked||a.seen_before?k.render("like",!0):a.favorite_before?k.render("favorite",!0):a.share_before?k.render("share",!0):(k.isFromRecommend||!window.is_login)&&k.render("other",!0)),
j){
var A=[];
j&&((i.old_liked||a.old_liked_before)&&A.push("like"),(i.liked||a.seen_before)&&A.push("zaikan"),
a.favorite_before&&A.push("collect"),a.share_before&&A.push("share"),A.length>0&&j.renderLikeProfile(A));
}
}
function s(){
