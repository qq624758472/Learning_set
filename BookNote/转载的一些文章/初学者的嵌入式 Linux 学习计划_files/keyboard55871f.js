...
var t=e("biz_wap/jsapi/core.js"),n=e("appmsg/i18n.js"),i=e("biz_common/utils/url/parse.js"),o=e("biz_wap/utils/ajax.js"),a=e("appmsg/retry_ajax.js"),l=e("biz_common/dom/event.js"),r=e("pages/utils.js"),s=e("common/utils.js"),c=e("biz_wap/utils/openUrl.js"),m=e("common/keyboard.js"),p=e("common/actionSheet.js"),d=e("biz_wap/utils/jsmonitor_report.js"),u=e("biz_common/tmpl.js"),y=e("appmsg/comment/comment_list/comment_item.html.js"),_=e("appmsg/comment/comment_list/item.html.js"),f=e("biz_wap/utils/mmversion.js"),g=f.is_wxwork,h=f.isWechat,v=h&&!g,D=e("biz_wap/utils/device.js"),b=D.os.pc&&!g,k=e(b?"appmsg/emotion/emotion_pc.js":"appmsg/emotion/emotion.js"),w=e("appmsg/comment/comment_input/comment_input.js"),L=e("appmsg/comment/comment_write_dialog/comment_write_dialog.js"),C=e("pages/scrollY.js"),I=e("appmsg/comment/comment_report.js"),j=I.report22215,R=e("appmsg/comment/comment_length.js"),T="praised",P="js_item",x="js_comment_item",S="js_reply_item",H="js_comment_praise",M="js_reply_praise",z="praise_num",E="js_comment_del",N="js_reply_del",A="js_comment_main",W="js_extend_comment",q="discuss_media_active",O="js_can_reply",B="js_folder",V="js_comment_reply_pc",F="js_reply_reply_pc",K="js_input_pc",U="js_dropdown",Y="js_comment_complain",Q="js_reply_complain",G="commenting",X="openning",Z="comment_primary_input_multiline",$=2,J=R.getLimit("reply"),et=s.getInnerHeight(),tt=f.isAndroid&&m.canUseCancel,nt=r.getId("activity-name")||"";
...
}(),at=ot.enableSelect,lt=ot.disableSelect,rt=function(){
...
}("http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0"),ut=function(){
function e(t){
var n=this;
...
o.classList.contains(O)&&(i.preventDefault(),t.commentReply(e,o,a,l));
};
...
}),t.showActionSheet(e,a,l),o.classList.remove(q),i.preventDefault(),p=!0;
};
...
var u=null,y=null,_=function(){
var e=function(e,t){
u=setTimeout(function(){
e.classList.add(q),u=null;
},t);
};
return function(t){
var n=t.el;
lt(),y=n,e(n,n.classList.contains(O)?100:200);
};
}();
...
var f=function(e){
var t=e.el;
u?(clearTimeout(u),u=null):t.classList.remove(q);
};
...
var g=function(){
var e=function(e){
e.classList.remove(q),u&&(clearTimeout(u),u=null),p&&(p=!1);
};
return function(t){
var n=t.el;
setTimeout(function(){
at();
},300),y=null,n.classList.contains(O)?setTimeout(function(){
return e(n);
},200):e(n);
};
}();
...
}),2===st&&m.onGetKeyboardHeight(function(e){
...
value:function(e,t){
var n=this;
this.data=e,"reply"!==this.type?this.container.innerHTML=mt(this.getCommentListHTML(e)).innerHTML:(this.cmtData=t,
this.container.innerHTML=mt(this.getReplyListHTML(e,t)).innerHTML),this.itemList=Array.prototype.slice.call(r.qsAll("."+P,this.container)),
...
t.style.cssText="-webkit-line-clamp: 10;",r.qs(".js_fake_content",e).offsetHeight>t.offsetHeight&&(r.qs("."+B,e).style.display="");
},0);
},0);
...
value:function(t){
t.time=e.dateToString(t.create_time),t.status="",dt(t),t.content=t.content.htmlDecodeLite().htmlEncodeLite(),
t.nick_name=ct(t.nick_name.htmlDecodeLite().htmlEncodeLite()),t.is_from_friend=t.is_from_friend||0,
...
!t.logo_url&&(t.logo_url=this.globalData.headImg)):t.nick_name=ct(t.nick_name.htmlDecodeLite().htmlEncodeLite()),
dt(t),u.tmpl(_,{
item:t,
deviceIsPc:b,
isWxWork:g,
...
for(var i=document.createDocumentFragment(),o=[],a=mt(this[e](t,n)).childNodes;a.length;){
var l=a[0];
...
value:function(t,n){
var i,o=this;
n=_extends((i={},_defineProperty(i,H,null),_defineProperty(i,M,null),_defineProperty(i,E,null),
_defineProperty(i,N,null),_defineProperty(i,W,null),_defineProperty(i,A,null),_defineProperty(i,S,null),
_defineProperty(i,B,null),i),n);
var a=Object.keys(n);
...
if(1===t)return pt("回复已被关闭"),!1;
if(e.is_from_me)return!0;
if(0===t)pt("作者已设置其他人不能回复");else if(3!==t||this.globalData.isFans){
if(4!==t||this.globalData.isFansDays)return!0;
pt("作者已设置关注7天后才可回复");
}else pt("作者已设置关注后才可以回复");
return!1;
}
},{
key:"sendReply",
