...
function O(e){
try{
for(var d=window.pageYOffset||document.documentElement.scrollTop,c=0;c<W.length;c+=F){
var m=W[c];
if(!(m.offsetTop>d+E.getInnerHeight()+100)){
var l=u.attr(m,"data-cpsstatus");
if("hide"==l){
m.setAttribute("data-cpsstatus","loading");
for(var g=""+c,_=1,h=c+1;h<W.length&&c+F>h;h++)g=g+"%2c"+h,_++;
...
var c=W[e.product_list[t].index],m=e.product_list[t].template_id;
...
if(!e&&1*n.dataset.ready===0)return!i&&P.show("生成订单中"),new Date-_>6e4?(P.hide(),
...
var Et=Math.random();
if(2e-4>Et)try{
for(var kt=document.getElementsByTagName("img"),Bt=window.screen.height,Pt=window.screen.width,zt=0,St=window.devicePixelRatio,zt="",J=0,Rt=kt.length;Rt>J;J++){
var Tt=kt[J].getAttribute("data-src");
if(Tt){
var Ct=kt[J].getBoundingClientRect();
zt+=Pt+"|"+Bt+"|"+Ct.left.toFixed(2)+"|"+(Pt-Ct.right).toFixed(2)+"|"+Ct.width.toFixed(2)+"|"+St.toFixed(2)+"|"+Tt+";";
}
}
w({
...
e("appmsg/popup_report.js")),B=e("appmsg/pay_report_utils.js"),P=e("appmsg/loading.js"),z=-1,S=e("appmsg/finance_communicate.js"),R=e("appmsg/topbar.js"),T=e("biz_wap/utils/jsmonitor_report.js"),C=e("appmsg/getForbidConfig.js"),O=e("appmsg/set_article_read.js"),q=O.setArticleRead,N=!1;
