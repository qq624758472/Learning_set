...
function t(e){
var t=void 0;
e===W.POS_MID&&(t=document.getElementsByTagName("mpcpc")),k[e]=t.length;
for(var i=0;i<t.length;i++)z[M.getPosKeyDesc(e,i)]=t[i];
}
function i(){
t(W.POS_MID);
}
...
if(e=0,B&&(B.style.display="none"),F&&(F.style.display="none"),k[W.POS_MID])for(var o=0;o<k[W.POS_MID];o++){
var a=z[M.getPosKeyDesc(W.POS_MID,o)];
...
function n(e,t,i,o){
if(e.pos_type===W.POS_MID&&!k[W.POS_MID]){
if(!G){
var a=Date.now();
G=v(H,{
...
n=n&&e.position_index>=0&&e.position_index<G.length;
var r=o?(i+1)/(o+1)*G.length:G.length/2,s=n?e.position_index:Math.floor(r)-1;
s=0>s?0:s;
var d=G[s],p=d.parentNode,_=document.createElement("p");
p.appendChild(_);
var m=_.offsetWidth;
if(p.removeChild(_),m<.7*H.offsetWidth){
...
z[M.getPosKeyDesc(W.POS_MID)]=c,P.insertAfter(c,d),t&&M.report115849(2);
}
}
function r(){
...
var p=e[d];
if((p.pos_type===W.POS_BOTTOM||p.pos_type===W.POS_AD_AFTER_VIDEO)&&"5"===window.item_show_type)continue;
var _=M.getCrtExpInfo(p),m=110===_.exp_type,f=g.isAndroid&&g.gtVersion("7.0.15",!0),c=p.pos_type===W.POS_MID&&"1"===M.getExpParaVal(p,100280),u=!!A.getQuery("forcewebcompt"),l=p.pos_type===W.POS_MID,h=p.pos_type===W.POS_AD_BEFORE_VIDEO,v=p.pos_type===W.POS_BOTTOM&&"1"===M.getExpParaVal(p,100316),w=p.pos_type===W.POS_BOTTOM;
if(l&&t++,c&&i++,w&&o++,f&&(s&&"error"===s.status&&M.report128729(64),s&&"loading"===s.status&&M.report128729(65)),
s&&"ready"===s.status&&f&&(c||v||m||u))r.push(p);else if(l||h&&0===p.is_mp_video||w||p.pos_type===W.POS_AD_AFTER_VIDEO||p.pos_type===W.POS_AD_MID_VIDEO||h&&1===p.is_mp_video||p.pos_type===W.POS_SPONSOR)n.push(p);else{
a.push(p);
...
for(var I=[],O={
aid:Date.now(),
pos_type:W.POS_BOTTOM
},d=n.length-1;d>=0;d--)n[d].pos_type===W.POS_BOTTOM&&I.push(n.splice(d,1)[0]);
O.children=I.reverse(),O.flow_exp_info=O.children[0].flow_exp_info,n.push(O);
}
if(window.is_temp_url&&t<k[W.POS_MID])for(var d=t;d<k[W.POS_MID];d++){
var D=_extends({
...
function s(e,t){
if(!e)return e;
var i=document.createElement("iframe"),o=M.getExpParaVal(t,94574),a=1*M.getExpParaVal(t,104690)===1&&-1!==[W.POS_BOTTOM,W.POS_MID].indexOf(t.pos_type),n=A.getQuery("forceframeversion");
...
function u(e,t){
q&&A.getQuery("adWidth")&&(document.documentElement.style.width=A.getQuery("adWidth")+"px");
var i={};
...
if(a)for(var s in a)(a[s].pos_type===W.POS_AD_BEFORE_VIDEO||a[s].pos_type===W.POS_AD_AFTER_VIDEO)&&(delete a[s],
o.advertisement_num--);
o.advertisement_num&&C.set(j,{
...
J=new c,J.handleAdWithFrame(d.newAdInfos,d.midAdDataCount,i.appid),Q=new N,Q.config({
adElCountMapByPos:k,
insertAutoAdElement:n
}),Q.handleAd(d.webComponentAdInfos,d.webComptMidAdDataCount),!i.flag&&i.advertisement_num>0&&(window.adDatasRealNum=i.advertisement_num);
}
function l(){
return J;
}
...
this.aInfoMap[e.aid].iframeEle=s(F,e),M.report115849(9);
...
i.aInfo.pos_type===W.POS_MID&&(t=o&&o.dataset&&o.dataset.category_id_list),d(e,E.SET_PAGE_DATA_ACTION_NAME,{
biz:window.biz,
uin:window.uin,
scene:window.scene,
...
contentOffsetHeight:L?L.offsetHeight:0,
...
e.height&&(t.style.height=e.height),q&&a(parseInt(e.height,10)),this.aInfoMap[e.aid].aInfo.pos_type===W.POS_BOTTOM&&!this.hasReportBottomTime&&"5"===window.item_show_type){
...
"removeADCache"===i.methodName&&C.remove(j);
}
...
e.pos_type===W.POS_AD_AFTER_VIDEO&&x.sendMPPageData(JSON.stringify({
aInfo:e,
dataType:"adData"
}),"adWeb");
});
...
e.pos_type===W.POS_AD_AFTER_VIDEO&&(d(t.contentWindow,E.SET_PAGE_DATA_ACTION_NAME,{
...
aInfo:e
},e.pos_type===W.POS_MID?(a.initMidAd(e,o),void o++):e.pos_type===W.POS_AD_BEFORE_VIDEO?(0===e.is_mp_video?M.report115849(18):P.report120081(2),
void a.initAdBeforeVideo(e)):e.pos_type===W.POS_BOTTOM?void a.initBottomAd(e):e.pos_type===W.POS_AD_AFTER_VIDEO?(a.hasAdAfterVideo=!0,
void(P.isWcSlPage()?x.setHasAdData4WcSlPlayer(!0):P.isNativePage()?x.createTailWebview(!0):(M.report115849(33),
a.initAdAfterVideo(e)))):e.pos_type===W.POS_AD_MID_VIDEO?(a.hasAdMidVideo=!0,void a.initAdMidVideo(e)):void(e.pos_type===W.POS_SPONSOR&&a.initSponsorAd(e));
}),x.setTailOpts({
...
t.pos_type===W.POS_AD_MID_VIDEO&&-1!==e.indexOf(W.POS_AD_MID_VIDEO)&&this.initAdMidVideo(t);
});
};
var J=null,Q=null;
return i(),{
