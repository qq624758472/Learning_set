...
i.seek_loaded=r;
for(var p=[],l=30;i.musicid.length>0;){
var a={};
for(var o in i)i.hasOwnProperty(o)&&("[object Array]"==Object.prototype.toString.call(i[o])?(a[o]=i[o].splice(0,l),
...
if("img"==t){
var p=new Image,l="//mp.weixin.qq.com/mp/jsmonitor?idkey="+e;
o>0&&(l+="&lc="+o+"&"+n.join("&")),l+="&t="+Math.random(),p.src=l;
}else{
var c={};
o>0&&(c=a),c.idkey=e,c.lc=o,_({
type:"POST",
...
for(var u in j.mutexPlayers)for(var r=0,p=j.mutexPlayers[u].length;p>r;r++)s++;
for(var u in j.mutexPlayers)for(var r=0,p=j.mutexPlayers[u].length;p>r;r++){
...
var r=!1,p=JSON.stringify(t||{});
if("error"==s){
o.jsapiLog("onBackgroundAudioStateChange error;res:"+p);
for(var d in o._g.stateChangeCallback)o._g.stateChangeCallback.hasOwnProperty(d)&&"function"==typeof o._g.stateChangeCallback[d]&&(r=!0,
o._g.stateChangeCallback[d](-1,t.errMsg||""),o._g.stateChangeCallback[d]=null);
}else"function"==typeof o._g.stateChangeCallback[s]&&(j.debug,o.jsapiLog("onBackgroundAudioStateChange "+s+";res:"+p),
r=!0,o._g.stateChangeCallback[s](0),o._g.stateChangeCallback[s]=null);
r||"function"!=typeof j.jsapiGlobalEvent[s]||(o.jsapiLog("onBackgroundAudioStateChange "+s+" unHandle;res:"+p),
...
var A=t("biz_wap/utils/mmversion.js"),b=(t("pages/report.js"),t("biz_common/dom/event.js"),
...
v(t.playbackRate),!!j.debug&&console.log("_synPlayStatus mutexKey:"+n.mutexKey),
...
var t=this._o;
!t.fileSize||t.fileSize>300||A.gtVersion("6.3.28",!0)||(this._trigger("androidForceH5"),
this._g._playtype=2);
}
...
},i.prototype._onEnd=function(t,e,i){
...
var a=1*p._status;
!o||1!==a&&2!==a&&4!==a?(e("waiting"),d.stateChangeCallback.play=function(t,o){
0==t?e("play"):0!=t&&i({
err_code:2,
err_msg:o||""
});
...
var o=t.onError,a=t.onSuccess,n=t.needStartMusicUI,s=t.playAudioId,u=t.playbackRate,r=t.startTime,p=t.isDoubleSpeed;
...
j.surportType=3,e._onLoading()):"play"===t&&(e._initJsapiData(),e._onPlay(),e._analogUpdateTime(!!p),
...
"function"!=typeof e&&(e=function(){}),"function"!=typeof i&&(i=function(){}),A.isWechat&&(A.isIOS||A.isAndroid)&&A.gtVersion("7.0.5",!0)?this._jsapiPlay({
needStartMusicUI:!0,
onError:function(){
e();
},
...
v(s),o._h5Audio.playbackRate=s,o._h5Audio.play(),i(),e();
}();
