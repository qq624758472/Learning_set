...
def upload_file(url,username,password,upload_url,file_dir):
    ...
    print upload_link
    with open('D:\\work_test\\upload_link.txt','w')as f:
        f.write(upload_link)
    try:
...
if __name__=='__main__':
    url='http://192.168.6.52:8000'
    username='111@saming.com'
    password='111'
    upload_file_url='http://192.168.6.17:8000/api2/repos/e6e38b46-0352-4ee3-a1cf-69e353dee693/upload-link/'
    upload_file_dir='C:/Users/hao/Downloads/liushihao.mp4'
