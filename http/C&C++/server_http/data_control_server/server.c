...
int main(int argc, char **argv) 
{
    ...
    evhttp_set_cb(http, "/control", php_request_cb, NULL);
    evhttp_set_cb(http, "/status", http_status_cb, NULL);
    evhttp_set_cb(http, "/stop-process", cb_stop_process, NULL);
    evhttp_set_cb(http, "/getdatalib", get_history_operating_datalib, NULL);
